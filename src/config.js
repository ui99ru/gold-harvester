...
export const CFG = {
  ...
  calmFlatG: 0.75, calmGroundY: 0.6,   // нижний слой: «плашмя» = наклон <41° (cos), круче — валим; выше calmGroundY (куча) — мягкий calmFlat
  gate1cost: 10, gate2cost: 600, upgradeCost: 120, startCoins: 5,   // разблок ворот накоплением / старт 5 монет
  gateBurst: 9, burstFwd: 5.5, burstUp: 3.0,   // волна из ворот (реф f_0080-0100): макс физ-копий на монету / скорость вперёд / вверх
  gateMinV: 1.0,   // мин. скорость пересечения вдоль нормали ворот: медленное продавливание кучей не множит (анти-фарм парковкой)
  coinN: 1000,   // пул тел монет (потолок на экране). Замер worst-case (все бодрствуют, sim-only): 700→7.1мс, 1000→11.2мс, 1200→13.8мс, 1800→22.9мс/шаг — выше 1000 не лезет в кадр 60fps
