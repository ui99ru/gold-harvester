...
**Главная цель проекта — максимально точно воспроизвести физику, геймплей и дизайн из референс-ролика [`refs/demo.mp4`](refs/demo.mp4)** (рекламный креатив Gold and Goblins, AppQuantum). Не сам idle/merge-геймплей Gold and Goblins, а именно ощущение «дозер + золото + ворота + пады» из ролика — **миниатюрная реалистичность**: веришь, что это маленькие тяжёлые кусочки металла.

**Ведущий вектор развития — ASMR/залипательность + антистресс** (сенсорное средство + эмоциональный контракт): весь геймплей должен ощущаться как «oddly satisfying» видео — высокие требования к цвету, детализации и звуку, и игра расслабляет, а не напрягает. В этой иерархии `demo.mp4` — **один из ориентиров** (база палитры/композиции/ощущения массы), а не верховный судья. Принципы и проверяемые критерии — в [docs/ASMR.md](docs/ASMR.md).
...
<p align="center"><img src="docs/drive.gif" width="280" alt="Проезд: змейка через кучу золота, ссыпка в ворота ×10"></p>
<sub>Живой проезд (скриптованная траектория `tools/_gifdrive.mjs`): змейка сквозь кучу — монеты физически разлетаются и едут в ковше — ссыпка в мат ворот ×10 — манёвры между воротами.</sub>
...
**Принцип:** где ролик расходится с текстом ТЗ — **главнее ролик** (лавандовый грунт, красно-белые ворота). Но где **залипательность** (вектор [docs/ASMR.md](docs/ASMR.md)) расходится с роликом — решает залипательность; ролик остаётся ориентиром палитры/композиции, а измеримый цикл ниже — инструментом базовой настройки, не финальным вердиктом.
