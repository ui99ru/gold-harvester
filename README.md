...
Палитра сведена с эталоном по hue-маскам (грунт/золото/яркость): SCORE establish **150 → 29** по измеренным проходам (грунт-лаванда, золото без «латуни» и синевы от окружения, ровная яркость без пересвета). Ось коридора, крутой диорамный наклон без горизонта, праздничный свет — по рефу.
